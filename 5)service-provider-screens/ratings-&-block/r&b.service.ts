...
export class rAndbService {
    ...
    public async updateBlockedCust(blocked: FavoriteAndBlocked): Promise<[number, FavoriteAndBlocked[]] | [affectedCount: number]> {
        return this.rAndbRepository.updateBlockedCust(blocked);
    }

    public async createBlockedCust(favorite: FavoriteAndBlocked): Promise<FavoriteAndBlocked | null> {
