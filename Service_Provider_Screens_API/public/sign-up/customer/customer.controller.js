                            ...
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, this.customerService
                                            ...
                                            .then(function (user) { return __awaiter(_this, void 0, void 0, function () {
                                            var emailToken, activateLink;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, this.customerService.generateToken(req.body.Email)];
                                                    case 1:
                                                        emailToken = _a.sent();
                                                        return [4 /*yield*/, this.customerService.activateLink(req.body.Email, emailToken)];
                                                    case 2:
                                                        activateLink = _a.sent();
                                                        return [4 /*yield*/, mg.messages().send(activateLink)];
                                                    case 3:
                                                        _a.sent();
                                                        return [2 /*return*/, res.status(200).json("Registration Success, Please verify your account within 2 hours!")];
                                                }
                                            });
                                        }); })
