...
var settings_repository_1 = require("../../service-provider-screens/sp-settings/settings.repository");
var settings_model_1 = require("../../service-provider-screens/sp-settings/settings.model");
var settings_service_1 = require("../../service-provider-screens/sp-settings/settings.service");
var settings_controller_1 = require("../../service-provider-screens/sp-settings/settings.controller");
 ...
 *     description: Failure
 */
spSettingsRouter.put('/update-sp-details', (0, celebrate_1.celebrate)(detailsAdd), loginController.validateToken, controller.updateSPDetails);
/**
 * @swagger
 * /change-sp-password:
 *  put:
 ...
 *     description: Failure
 */
spSettingsRouter.put('/change-sp-password', (0, celebrate_1.celebrate)(passwordAdd), loginController.validateToken, controller.changePassword);
