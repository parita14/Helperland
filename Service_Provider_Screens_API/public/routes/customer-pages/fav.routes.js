...
var fav_model_1 = require("../../customer-pages/favourite-pros/fav.model");
 ...
 *     description: Failure
 */
favRouter.post('/create-favorite-pros/:spId', (0, celebrate_1.celebrate)(favAdd), loginController.validateToken, controller.FavSP, controller.removeFavSp);
/**
 * @swagger
 * /get-all-pros:
 *  get:
 ...
 *     description: Failure
 */
favRouter.post('/create-blocked-pros/:spId', (0, celebrate_1.celebrate)(blockAdd), loginController.validateToken, controller.blockSP, controller.removeBlockedSp);
