                                                ...
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        ...
                                                        case 1:
                                                            ...
                                                            if (matched) {
                                                                return [2 /*return*/, res.status(200).json("Another Service Request of ServiceId #".concat(srId, " has already been assigned which has time overlap with service request. You can't pick this one!"))];
                                                            }
                                                            else {
                                                                next();
                                                            }
