                                    ...
                                    return _this.dashboardService
                                        ...
                                        return __generator(this, function (_a) {
                                            if (service) {
                                                if (service.length > 0) {
                                                    for (s in service) {
                                                        date1 = new Date(service[s].ServiceStartDate);
                                                        date2 = new Date((0, moment_1.default)(new Date()).format("YYYY-MM-DD"));
                                                        if (date1 > date2) {
                                        ...
                                        if (service) {
                                            if (user.UserId === service.UserId) {
                                                for (var s in service) {
                                                    var date1 = new Date(service.ServiceStartDate);
                                                        ...
                                                        return _this.dashboardService
                                                            ...
                                                            if (serviceRequest.length > 0) {
                                                                if (service.ServiceProviderId) {
                                                                    return _this.dashboardService
                                                                        ...
                                                                        return __generator(this, function (_a) {
                                                                            switch (_a.label) {
                                                                                ...
                                                                                case 2:
                                                                                    _a.sent();
                                                                                    return [2 /*return*/, res.status(200).json("Service Request with Service Id #".concat(service.ServiceId, " cancelled successfully!"))];
                                                                    ...
                                                                    return res.status(200).json("Service Request with Service Id #".concat(service.ServiceId, " cancelled successfully!"));
                                                                }
                                                            }
                                                            else {
