...
import { SettingsRepository } from "../../5)service-provider-screens/sp-settings/settings.repository";
import { SettingsSchema } from "../../5)service-provider-screens/sp-settings/settings.model";
import { SettingsService } from "../../5)service-provider-screens/sp-settings/settings.service";
import { SettingsController } from "../../5)service-provider-screens/sp-settings/settings.controller";
