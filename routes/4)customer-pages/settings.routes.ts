...
import { SettingsRepository } from "../../4)customer-pages/my-settings/settings.repository";
import { SettingsSchema } from "../../4)customer-pages/my-settings/settings.model";
import { SettingsService } from "../../4)customer-pages/my-settings/settings.service"; 
import { SettingsController } from "../../4)customer-pages/my-settings/settings.controller"; 
