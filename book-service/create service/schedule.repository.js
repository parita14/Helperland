...
var ScheduleRepository = /** @class */ (function () {
    ...
    ScheduleRepository.prototype.createFAndB = function (FAndB) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ScheduleRepository.prototype.findUserById = function (UserId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ScheduleRepository.prototype.findById = function (UserId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, index_1.db.Users.findAll({ where: { UserId: UserId } })];
            });
        });
    };
    ...
    ScheduleRepository.prototype.findByTargetId = function (UserId, TargetUserId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, index_1.db.FavoriteAndBlocked.findOne({ where: { UserId: UserId, TargetUserId: TargetUserId } })];
            });
        });
    };
