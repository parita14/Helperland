        ...
        this.forgotPassword = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.passwordService
                        ...
                        var resetToken = _this.passwordService.generateToken(user.UserId);
                        var resetLink = _this.passwordService.resetLink(user.Email, resetToken);
                        var mail = mg.messages().send(resetLink);
                        if (!mail) {
