    ...
    function CustomerController(customerService) {
        ...
        this.createCustomer = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                doMatch = req.body.Password === req.body.ConfirmPassword;
                if (!req.body.Email) {
                ...
                return [2 /*return*/, this.customerService
                        .findCustomerByEmail(req.body.Email)
                        .then(function (user) { return __awaiter(_this, void 0, void 0, function () {
                        var _a, emailToken, activateLink, mail;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _a.Password = _b.sent();
                                    emailToken = this.customerService.generateToken(req.body.Email);
                                    activateLink = this.customerService.activateLink(req.body.Email, emailToken);
                                    mail = mg.messages().send(activateLink);
                                    if (!mail) {
                                        return [2 /*return*/, res.status(400).json("Mail not sent!")];
                                    }
                                    return [2 /*return*/, this.customerService
        ...
        this.activateCustomer = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (token) {
                    ...
                    return [2 /*return*/, res.json("Some error occurred!")];
                }
                return [2 /*return*/];
            });
        }); };
        ...
        this.getUsersById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.customerService
