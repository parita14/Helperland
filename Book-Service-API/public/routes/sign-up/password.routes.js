 ...
 */
passwordRouter.post('/forgot-password', (0, celebrate_1.celebrate)(forgotAdd), controller.forgotPassword);
/**
* @swagger
...
*     description: failure
*/
passwordRouter.post('/reset-password/:resetToken', (0, celebrate_1.celebrate)(resetAdd), controller.resetPassword);
