...
export class SettingsService {
    ...
    public async updateSPDetails( Email: string, FirstName: string, LastName: string, Mobile: string, DateOfBirth: Date, NationalityId: number, Gender: number, UserProfilePicture: number ): Promise<[number, User[]] | [affectedCount: number]> {
        return this.settingsRepository.updateSPDetails(Email, FirstName, LastName, Mobile, DateOfBirth, NationalityId, Gender, UserProfilePicture);
    }
