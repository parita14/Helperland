...
var dashboard_routes_1 = __importDefault(require("./routes/customer-pages/dashboard.routes"));
var history_routes_1 = __importDefault(require("./routes/customer-pages/history.routes"));
var fav_routes_1 = __importDefault(require("./routes/customer-pages/fav.routes"));
var settings_routes_1 = __importDefault(require("./routes/customer-pages/settings.routes"));
var newService_routes_1 = __importDefault(require("./routes/sp-screens/newService.routes"));
var upcoming_routes_1 = __importDefault(require("./routes/sp-screens/upcoming.routes"));
var history_routes_2 = __importDefault(require("./routes/sp-screens/history.routes"));
var r_b_routes_1 = __importDefault(require("./routes/sp-screens/r&b.routes"));
var spSettings_routes_1 = __importDefault(require("./routes/sp-screens/spSettings.routes"));
var sr_routes_1 = __importDefault(require("./routes/admin-screens/sr.routes"));
var user_routes_1 = __importDefault(require("./routes/admin-screens/user.routes"));
