                        ...
                        if (error) {
                            ...
                            if (Email_1) {
                                ...
                                return _this.settingsService
                                    ...
                                    if (findUser) {
                                        return _this.settingsService
                                            .updateUserDetails(UserEmail_1, FirstName_1, LastName_1, Mobile_1, DateOfBirth_1)
                                            .then(function (user) {
                                        ...
                                        return _this.settingsService
                                            ...
                                            if (id) {
                                                if (findUser.Email === id.Email) {
                                                    return _this.settingsService
                                                        .updateUserAddress(+req.params.Id, AddressLine1_1, AddressLine2_1, City_1, State_1, PostalCode_1, Mobile_2)
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            isOld = bcryptjs_1.default.compare(req.body.OldPassword, findUser.Password);
                                            if (!isOld) {
                                        ...
                                        case 2: return [2 /*return*/, res.status(404).json("User not exist!")];
                                    }
                                });
                            }); })
                                .catch(function (error) {
