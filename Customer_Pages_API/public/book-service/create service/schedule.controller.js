                                                ...
                                                if (service) {
                                                    if (service.ServiceProviderId) {
                                                        ...
                                                        return [2 /*return*/, this.scheduleService
                                                                ...
                                                                var _a, _b, _i, s, serviceRequest;
                                                                return __generator(this, function (_c) {
                                                                    switch (_c.label) {
                                                                        case 0:
                                                                            if (!(sp.length > 0)) return [3 /*break*/, 6];
                                                                            _a = [];
                                                                            for (_b in sp)
                                                                                _a.push(_b);
                                                                            _i = 0;
                                                                        ...
                                                                        case 1:
                                                                            ...
                                                                            s = _a[_i];
                                                                            return [4 /*yield*/, this.scheduleService.serviceRequest(sp[s].Email, service.ServiceId)];
                                                                        case 2:
                                                                            serviceRequest = _c.sent();
                                                                            return [4 /*yield*/, mg.messages().send(serviceRequest)];
                                                                        case 3:
                                                                            _c.sent();
                                                                            _c.label = 4;
                                                                        case 4:
                                                                            _i++;
                                                                            return [3 /*break*/, 1];
                                                                        case 5: return [2 /*return*/, res.status(200).json({ message: "Booking has been successfully submitted!", ServiceId: service.ServiceId })];
                                                                        case 6: return [2 /*return*/, res.status(404).json("No service provider found!")];
                                                                    }
                                                                });
                                                            }); })
                                                                .catch(function (error) {
                                    ...
                                    return _this.scheduleService
                                        ...
                                        if (Address.length > 0) {
                                            ...
                                            if (serviceAddress.length > 0) {
                                                return res.status(200).json({ serviceAddress: serviceAddress });
                                            }
                                            else {
                                    ...
                                    return _this.scheduleService
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1: return [4 /*yield*/, this.scheduleService.getTargetUser(user)];
                                                case 2:
                                                    favSP = _a.sent();
                                                    if (favSP.length > 0) {
                                                        return [2 /*return*/, this.scheduleService
