...
var SpHistoryService = /** @class */ (function () {
    ...
    SpHistoryService.prototype.getAllCompletedRequest = function (ServiceProviderId, ZipCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.spHistoryRepository.getAllCompletedRequest(ServiceProviderId, ZipCode)];
            });
        });
    };
    SpHistoryService.prototype.getServiceById = function (ServiceId, ServiceProviderId, ZipCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.spHistoryRepository.getServiceById(ServiceId, ServiceProviderId, ZipCode)];
            });
        });
    };
    ...
    SpHistoryService.prototype.compareDate = function (history) {
        var sphistory = [];
        var currentDate = new Date(moment_1.default(new Date()).format("YYYY-MM-DD"));
        for (var h in history) {
            var date = history[h].ServiceStartDate;
            var ServiceStartDate = new Date(moment_1.default(date).format("YYYY-MM-DD"));
