...
var setService_repository_1 = require("../../3)book-service/setup-service/setService.repository");
var setService_models_1 = require("../../3)book-service/setup-service/setService.models");
var setService_service_1 = require("../../3)book-service/setup-service/setService.service");
var setService_controller_1 = require("../../3)book-service/setup-service/setService.controller");
 ...
 *      description: Failure
 */
serviceRouter.post('/set-service', celebrate_1.celebrate(zipAdd), loginController.validateToken, controller.setService);
