...
var upcoming_repository_1 = require("../../5)service-provider-screens/upcoming-services/upcoming.repository");
var upcoming_model_1 = require("../../5)service-provider-screens/upcoming-services/upcoming.model");
var upcoming_service_1 = require("../../5)service-provider-screens/upcoming-services/upcoming.service");
var upcoming_controller_1 = require("../../5)service-provider-screens/upcoming-services/upcoming.controller");
 ...
 *     description: Failure
 */
upcomingServiceRouter.post('/cancle-service-request-by-SP/:ServiceId', celebrate_1.celebrate(cancleAdd), loginController.validateToken, controller.cancleServiceRequest);
/**
 * @swagger
