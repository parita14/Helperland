...
var r_b_repository_1 = require("../../5)service-provider-screens/ratings-&-block/r&b.repository");
var r_b_model_1 = require("../../5)service-provider-screens/ratings-&-block/r&b.model");
var r_b_service_1 = require("../../5)service-provider-screens/ratings-&-block/r&b.service");
var r_b_controller_1 = require("../../5)service-provider-screens/ratings-&-block/r&b.controller");
 ...
 *     description: Failure
 */
rAndbRouter.post('/create-blocked-customer/:custId', celebrate_1.celebrate(blockAdd), loginController.validateToken, controller.blockCust, controller.removeBlockedCust);
