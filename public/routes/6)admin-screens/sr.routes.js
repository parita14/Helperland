...
var sr_repository_1 = require("../../6)Admin-screens/service-requests/sr.repository");
var sr_model_1 = require("../../6)Admin-screens/service-requests/sr.model");
var sr_service_1 = require("../../6)Admin-screens/service-requests/sr.service");
var sr_controller_1 = require("../../6)Admin-screens/service-requests/sr.controller");
...
var ServiceAdd = sr_model_1.srSchema.ServiceAdd, RescheduleAdd = sr_model_1.srSchema.RescheduleAdd, RefundAdd = sr_model_1.srSchema.RefundAdd;
...
*     description: Failure
*/
srRouter.put('/refund-amount/:ServiceId', celebrate_1.celebrate(RefundAdd), loginController.validateToken, controller.RefundAmount);
