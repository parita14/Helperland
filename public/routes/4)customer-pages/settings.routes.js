...
var settings_repository_1 = require("../../4)customer-pages/my-settings/settings.repository");
var settings_model_1 = require("../../4)customer-pages/my-settings/settings.model");
var settings_service_1 = require("../../4)customer-pages/my-settings/settings.service");
var settings_controller_1 = require("../../4)customer-pages/my-settings/settings.controller");
 ...
 *     description: Failure
 */
settingsRouter.put('/update-user-details', celebrate_1.celebrate(detailsAdd), loginController.validateToken, controller.updateUserDetails);
/**
 * @swagger
 * /create-user-address:
 *  post:
 ...
 *     description: Failure
 */
settingsRouter.post('/create-user-address', celebrate_1.celebrate(createAddress), loginController.validateToken, controller.createUserAddress);
/**
 * @swagger
 * /get-user-address:
 *  get:
 ...
 *     description: Failure
 */
settingsRouter.put('/update-user-address/:AddressId', celebrate_1.celebrate(addressAdd), loginController.validateToken, controller.updateUserAddress);
/**
 * @swagger
 ...
 *     description: Failure
 */
settingsRouter.put('/change-user-password', celebrate_1.celebrate(passwordAdd), loginController.validateToken, controller.changePassword);
