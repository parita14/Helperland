...
var dashboard_repository_1 = require("../../4)customer-pages/dashboard/dashboard.repository");
var dashboard_model_1 = require("../../4)customer-pages/dashboard/dashboard.model");
var dashboard_service_1 = require("../../4)customer-pages/dashboard/dashboard.service");
var dashboard_controller_1 = require("../../4)customer-pages/dashboard/dashboard.controller");
 ...
 *     description: Failure
 */
dashboardRouter.post('/reschedule-service/:ServiceId', celebrate_1.celebrate(rescheduleAdd), loginController.validateToken, controller.rescheduleService, controller.rescheduleIfTimeSlotNotConflicts);
/**
 * @swagger
 ...
 *     description: Failure
 */
dashboardRouter.post('/cancle-service-request/:ServiceId', celebrate_1.celebrate(cancleAdd), loginController.validateToken, controller.cancleServiceRequest);
