...
var history_repository_1 = require("../../4)customer-pages/service-history/history.repository");
var history_model_1 = require("../../4)customer-pages/service-history/history.model");
var history_service_1 = require("../../4)customer-pages/service-history/history.service");
var history_controller_1 = require("../../4)customer-pages/service-history/history.controller");
 ...
 *     description: Failure
 */
historyRouter.post('/give-ratings/:ServiceRequestId', celebrate_1.celebrate(ratingAdd), loginController.validateToken, controller.giveRatings);
/**
 * @swagger
 * /export:
 *  get:
