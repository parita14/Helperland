                                        ...
                                        return _this.serviceService
                                            ...
                                            if (!sp) {
                                                ...
                                                if (!doMatch) {
                                                    ...
                                                    jsonwebtoken_1.default.verify(token, process.env.SECRET_KEY, function (err, helper) {
                                                        if (err) {
                                                            ...
                                                            var token_1 = _this.serviceService.generateToken(Email, ZipCode_1);
                                                            return res.status(200).cookie("token", token_1, { httpOnly: true }).json({ message: "Helper found!", token: token_1 });
                                                        }
                                                    });
                                                }
                                            }
