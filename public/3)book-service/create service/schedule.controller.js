                                                            ...
                                                            return _this.scheduleService
                                                                ...
                                                                return __generator(this, function (_a) {
                                                                    switch (_a.label) {
                                                                        ...
                                                                        case 2:
                                                                            _a.sent();
                                                                            return [2 /*return*/, res.status(200).json({ message: "Booking has been successfully submitted!", ServiceId: service.ServiceId })];
                                                                        case 3: return [2 /*return*/, res.status(400).json("Failure in creating service!")];
                                                                    }
                                                                });
                                                            }); })
                                                                .catch(function (error) {
                                    ...
                                    return _this.scheduleService
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1: return [4 /*yield*/, this.scheduleService.getTargetUser(user, User.ZipCode)];
                                                case 2:
                                                    favSP = _a.sent();
                                                    if (favSP.length > 0) {
