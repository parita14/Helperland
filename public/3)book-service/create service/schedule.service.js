...
var ScheduleService = /** @class */ (function () {
    ...
    ScheduleService.prototype.findSpInFav = function (UserId, TargetUserId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.scheduleRepository.findSpInFav(UserId, TargetUserId)];
            });
        });
    };
    ...
    ScheduleService.prototype.serviceAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var details, _a, _b, _i, a;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        details = [];
