...
var srService = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, service.filter(function (x) {
                            return (!filters.ServiceId || (x.ServiceId && x.ServiceId === filters.ServiceId)) &&
                                ...
                                (!(filters.Status === 'Refunded') || (x.Status === 'Refunded' && x.Status === 'Refunded')) &&
    ...
    srService.prototype.calculateAmount = function (paidAmount, Amount) {
        var cal;
        cal = ((Amount * 100) / paidAmount).toFixed(2);
        return cal;
    };
    srService.prototype.updateRefund = function (ServiceId, RefundedAmount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.srRepository.updateRefund(ServiceId, RefundedAmount)];
            });
        });
    };
    return srService;
