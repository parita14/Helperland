...
var ContactsController = /** @class */ (function () {
    function ContactsController(contactsService) {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        u = _a[_i];
                                        return [4 /*yield*/, this.contactsService.SendAdmin(user[u].Email, Name, req.body.Email, req.body.Subject, req.body.PhoneNumber, req.body.Message)];
                                    case 2:
                                        sendmail = _c.sent();
                                        return [4 /*yield*/, mg.messages().send(sendmail)];
                                    case 3:
                                        _c.sent();
                                        _c.label = 4;
                                    case 4:
                                        _i++;
                                        return [3 /*break*/, 1];
                                    case 5: return [2 /*return*/, res.status(200).json('Your message is submitted successfully')];
                                    case 6: return [2 /*return*/, res.status(200).json('Your message is submitted successfully')];
                                }
                            });
                        }); })
        ...
        this.getContactsById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.getContacts = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contactsService
                        .getContacts()
                        .then(function (contacts) {
        ...
        this.validate = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var token;
            var _this = this;
            return __generator(this, function (_a) {
